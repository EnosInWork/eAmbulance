RageUI.BadgeStyle = {
    ...
    Heart = function(Selected)
        return {
            ...
            BadgeColour = Selected and { R = 255, G = 0, B = 0, A = 100 } or { R = 255, G = 0, B = 0, A = 255 }
        }
    end,
    ...
    Lock = function(Selected)
        return {
            ...
            BadgeColour = Selected and { R = 0, G = 0, B = 0, A = 255 } or { R = 255, G = 255, B = 255, A = 100 }
        }
    end,
    ...
    Package = function(Selected)
        return {
            ...
            BadgeDictionary = "mpinventory",
            BadgeColour = Selected and { R = 0, G = 0, B = 0, A = 100 } or { R = 0, G = 0, B = 255, A = 255 }
        }
    end,
    Cash = function(Selected)
        return {
            ...
            BadgeDictionary = "mpinventory",
            BadgeColour = Selected and { R = 0, G = 0, B = 0, A = 100 } or { R = 0, G = 255, B = 0, A = 255 }
        }
    end,
